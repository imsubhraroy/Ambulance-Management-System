                        ...
                        <form role="form" action="EditPatientProfile" method="post">
                            ...
                            <div class="form-group">
                                <label>Gender</label> <select class="form-control"
                                    ...
                                    <option <% if(gender.equals("Male")) out.print("selected"); %>>Male</option>
                                    <option <% if(gender.equals("Female")) out.print("selected"); %>>Female</option>
                                    <option <% if(gender.equals("Others")) out.print("selected"); %>>Others</option>
