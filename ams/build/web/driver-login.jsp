        ...
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12 register-header">
                    <h4 class="header-line"><b>Driver Login</b></h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <img src="images/driver-login.jpg" style="width:460px;">
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <form action="DriverLogin" method="post">
                            ...
                            <div class="btn-sub">
                                <button type="submit" class="btn btn-info btn-reset-login">Login
                                </button>
                                <button type="reset" class="btn btn-danger btn-reset-login" id="btnReset">Reset</button>
                                <a class="for-pwd already" href="driver-register.jsp">New Driver Register</a>
                                <a class="for-pwd already" href="driver-forgot-password.jsp">Forgot your password?</a>
                            </div>
                    </div>
                </div>
            </div>
