            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="EditPatientProfileImage" method="post" enctype="multipart/form-data">
                            <%
                                byte[] imgData = null;
                            ...
                            %>
                                ...
                                <label>Full Name</label> <input class="form-control" type="text"
                                                                name="dname" value="<%=resultset.getString("patient_name")%>" readonly />
                            </div>
                            <div class="form-group">
                                <label>Email Id</label> <input class="form-control" name="email"
                                                               type="text" value="<%=resultset.getString("patient_email")%>" readonly />
                            </div>
                            <%
                                Blob image = resultset.getBlob(16);
