...
<body class="host_version">
    ...
    <jsp:include page="admin-header.jsp"></jsp:include>
        <div class="container-fluid" style="margin-bottom: 310px;">
            <div class="row pad-botm">
                <div class="col-md-12 register-header">
                    <h4 class="header-line"><b>All Ambulance</b></h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    <tr class="default">
                                        ...
                                        %>
                                        <td><span class="label label-success">Not Available</span></td>
                                        ...
                                        <td><a href="admin-delete-ambulance.jsp?id=<%=resultset.getString("id")%>" class="btn btn-danger">Remove Ambulance</a></td>
