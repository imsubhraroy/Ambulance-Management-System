        ...
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12 register-header">
                    <h4 class="header-line"><b>Patient Login</b></h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <img src="images/patient-login.jpg">
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="panel panel-info">
                        ...
                        <form action="PatientLogin" method="post">
                            ...
                            <div class="btn-sub">
                                ...
                                <a class="for-pwd already" href="patient-register.jsp">New Patient Register</a>
                                <a class="for-pwd already" href="patient-forgot-password.jsp">Forgot your password?</a>
                            </div>
                        </form>
                    </div>
                </div>
