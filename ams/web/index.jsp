			...
			<div class="item active">
				<div id="home" class="first-section"
					style="background-image: url('images/slide/1.jpg');">
                                    <div class="container" style="background: linear-gradient(to right,rgba(255,255,255,0.99) 1%,rgba(255,255,255,0.7) 100%,rgba(255,255,255,0) 89%); padding-top: 13px;">
						<div class="row">
							<div class="col-md-12 col-sm-12 text-center">
								<div class="big-tagline">
									<h2 data-animation="animated zoomInRight">
										<strong>Ambulance Management System</strong>
									</h2>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="message-box">
						<h4>Ambulance Management System</h4>
						<p class="lead">It is used for patients to, from or between places of medical treatment, such as hospital, dialysis center, Medical Appointments for non-urgent/ emergency care. Main aim of all such transfers is to maintain the continuity of medical care.</p>
					</div>
					<!-- end messagebox -->
				</div>
				...
				<div class="col-md-6">
					<div class="post-media wow fadeIn">
						<img src="images/logos/ambulance.jpg" alt=""
