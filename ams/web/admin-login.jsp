        ...
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12 register-header">
                    <h4 class="header-line"><b>Admin Login</b></h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <img src="images/admin-login.jpg" style="width: 500px;">
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="panel panel-info">
                        ...
                        <form action="AdminLogin" method="post">
                            ...
                            <div class="btn-sub">
                                ...
                                <button type="reset" class="btn btn-danger btn-reset-login" id="btnReset" style="margin-right: 160px;">Reset</button>
                                <a class="for-pwd already" href="admin-forgot-password.jsp">Forgot your password?</a>
                            </div>
                        </form>
                    </div>
                </div>
